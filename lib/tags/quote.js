...
var QuoteTag = exports["default"] = /*#__PURE__*/function (_Tag) {
  ...
  return _createClass(QuoteTag, [{
    ...
    value: function toReact() {
      var citation = this.params.quote;
      return /*#__PURE__*/_react["default"].createElement("blockquote", null, citation && /*#__PURE__*/_react["default"].createElement("small", null, citation, " wrote:"), this.getComponents());
    }
  }]);
}(_tag["default"]);