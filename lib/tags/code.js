...
var CodeTag = exports["default"] = /*#__PURE__*/function (_Tag) {
  function CodeTag(renderer) {
    var _this;
    var settings = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _classCallCheck(this, CodeTag);
    _this = _callSuper(this, CodeTag, [renderer, settings]);
  ...
  return _createClass(CodeTag, [{
    ...
    value: function toHTML() {
      ...
      if (lang) {
        return ["<pre class=\"prettyprint lang-".concat(lang, "\">"), this.getContent(true), '</pre>'];
      }
    ...
    value: function toReact() {
      if (this.inline) {
        return /*#__PURE__*/_react["default"].createElement("code", null, this.getContent(true));
      }
      var lang = this.params.lang || this.params[this.name];
      var className = 'prettyprint';
      if (lang) {
        className += " lang-".concat(lang);
      }
