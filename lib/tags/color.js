...
var ColorTag = exports["default"] = /*#__PURE__*/function (_Tag) {
  function ColorTag() {
    _classCallCheck(this, ColorTag);
    return _callSuper(this, ColorTag, arguments);
  }
  _inherits(ColorTag, _Tag);
  return _createClass(ColorTag, [{
    key: "toHTML",
    value: function toHTML() {
      ...
      return ["<span style=\"color:".concat(color, "\">"), this.getContent(), '</span>'];
    }
  }, {
    key: "toReact",
