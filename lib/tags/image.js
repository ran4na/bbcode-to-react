...
var ImageTag = exports["default"] = /*#__PURE__*/function (_Tag) {
  function ImageTag() {
    _classCallCheck(this, ImageTag);
    return _callSuper(this, ImageTag, arguments);
  }
  _inherits(ImageTag, _Tag);
  return _createClass(ImageTag, [{
    key: "toHTML",
    value: function toHTML() {
      ...
      return "<img ".concat(this.renderer.htmlAttributes(attributes), " />");
    }
  }, {
    key: "toReact",
