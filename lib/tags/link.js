...
var LinkTag = exports["default"] = /*#__PURE__*/function (_Tag) {
  function LinkTag() {
    _classCallCheck(this, LinkTag);
    return _callSuper(this, LinkTag, arguments);
  }
  _inherits(LinkTag, _Tag);
  return _createClass(LinkTag, [{
    key: "toHTML",
    value: function toHTML() {
      ...
      return this.renderer.context({
        ...
        return ["<a href=\"".concat(url, "\" target=\"_blank\">"), _this.getContent(), '</a>'];
      });
    }
  }, {
    key: "toReact",
